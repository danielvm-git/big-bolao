...
| BUG-2026-06-21-104800-stale-ranking-zombie-poller         | bot/handlers     | `test_bot.py` (409 conflict), `test_quiet_hours.py` | ✅ Covered                             |
...
| BUG-2026-06-30-140000-wrong-score-after-pen               | fixtures         | `test_fixtures.py::TestParseResultFieldSelection`   | ✅ Covered                             |
| BUG-2026-06-30-150000-web-scoring-not-phase-aware         | scoring          | `web/tests/scoring.test.js`                         | ⚠️ Partial (JS only, no Python)        |
| BUG-2026-07-03-191600-wrong-score-after-pen-recurrence    | fixtures         | `test_fixtures.py::TestParseResultFieldSelection`   | ✅ Covered (added after recurrence)    |
| BUG-2026-07-04-170000-knockout-exact-bets-mislabeled      | scoring          | `web/tests/scoring.test.js`                         | ⚠️ Partial (will be closed by e06-s03) |

**Summary:** 19 bugs tracked — ✅ 11 covered, ⚠️ 3 partial, ❌ 5 GAP
...
| 5   | Python scoring tests          | **e06-s02** — shared golden fixture |
...
| e06-s01: Test foundation | (this document)                                                           | 🔄 In progress                |
| e06-s02: Golden fixture  | `tests/test_scoring.py`, `web/tests/scoring-golden.test.js`               | 📅 Planned                    |
| e06-s03: Bug fix         | `web/tests/scoring-golden.test.js` (extended)                             | 📅 Planned                    |
| e06-s04: Parse golden    | `tests/test_fixtures.py` (re-sourced)                                     | 📅 Planned                    |
...
| -------------------- | -------------------- | ------ | ---------------------- |
| `bolao/scoring`      | 0% (no Python tests) | 90%    | e06-s05 coverage gate  |
| `bolao/fixtures`     | ~85%                 | 90%    | e06-s05 coverage gate  |
| `bolao/ranking`      | ~80%                 | 90%    | e06-s05 coverage gate  |
| `web/src/scoring.js` | ~70%                 | 85%    | e06-s05 (manual check) |
