...
* **matches:** update SF-02 with confirmed QF winners — Inglaterra vs Argentina ([ad433e6](https://github.com/danielvm-git/big-bolao/commit/ad433e6970c17872029994ed3c3674f01585fb7d))
...
- **scoring:** progressive Fibonacci knockout scoring (R32-FIN) ([65d4058](https://github.com/danielvm-git/big-bolao/commit/65d40581ee2cc84d980153ebada2063af391d758))
...
- **deploy:** add start script so BigBase runs app.py after npm build ([d3e6a22](https://github.com/danielvm-git/big-bolao/commit/d3e6a22711042b51041d163e547c5e5cb15dc0db))

# [1.12.0](https://github.com/danielvm-git/big-bolao/compare/v1.11.0...v1.12.0) (2026-06-21)

### Features

- **bot:** add /version command to expose running build ([e125fd8](https://github.com/danielvm-git/big-bolao/commit/e125fd8009fb439f61bc36b658570bc6f01f448f))
